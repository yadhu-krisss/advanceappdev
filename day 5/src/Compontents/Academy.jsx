...
//   const [eventName, setEventName] = useState('');
  ...
  const [events, setEvents] = useState([
    // Sample event data
    { id: 1, name: 'Smartchess Academy', themeCost: '', rating: 'Chennai', description: '' },
    { id: 1, name: 'Smartchess Academy', themeCost: '', rating: 'Coimbatore', description: '' },
    { id: 1, name: 'Smartchess Academy', themeCost: '', rating: 'Madurai', description: '' },
    { id: 1, name: 'Smartchess Academy', themeCost: '', rating: 'Theni', description: '' },
    { id: 1, name: 'Smartchess Academy', themeCost: '', rating: 'Trichy', description: '' },
